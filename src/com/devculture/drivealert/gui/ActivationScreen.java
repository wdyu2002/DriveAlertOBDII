...
public class ActivationScreen extends ApplicationScreen implements NotificationEventListener {
	...
	public boolean onNotificationReceived(int event, Object param) {
		...
		mString = OBDAgent.getStatusString();
		repaint();
		return true;
	}
	...
	private void onObdSuccess() {
		popState();
	}

	private void onObdError() {
		setSelectedItem(mSelectedItem);
	}
